            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-4">
              ...
              <div className="mt-3 pt-3 border-t border-zinc-200">
                <p className="text-xs text-zinc-500">
                  <span className="font-medium">Note:</span> You&apos;ll receive
                  a prorated credit for the unused portion of your current
                  billing cycle. The new lower price starts next billing cycle.
                </p>
              </div>
            </div>
          </div>
