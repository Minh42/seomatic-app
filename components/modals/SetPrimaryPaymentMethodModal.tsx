...
interface SetPrimaryPaymentMethodModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  isLoading?: boolean;
...
export function SetPrimaryPaymentMethodModal({
  isOpen,
  onClose,
  onConfirm,
  isLoading = false,
  cardBrand = 'card',
  cardLast4 = '****',
}: SetPrimaryPaymentMethodModalProps) {
          ...
          <div className="px-6 pb-6">
            ...
            <div className="p-3 bg-zinc-50 border border-zinc-200 rounded-lg">
              <p className="text-sm text-zinc-600">
                This card will be used for all future subscription payments and
                charges.
              </p>
            </div>
          </div>
